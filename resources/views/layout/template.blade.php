...
<html>
    <head>
        ...
        <title>Site de Vendas de Veículos</title>
        <!-- Favicon-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3" style="width: 22rem;">
                        <img src="{{asset('venda-carros/assets/img/honda-civic.png')}}" class="card-img-top" alt="Honda Civic">
                        <div class="card-body">
                            <h3>Honda Civic</h3>
                        </div>
                      </div>
                    <div class="col-lg-3" style="width: 21rem;">
                        <img src="{{asset('venda-carros/assets/img/toyota-corola.png')}}" class="card-img-top" alt="Toyota Corola">
                        <div class="card-body">
                            <h3>Toyota Corola</h3>
                        </div>
                    </div>
                    <div class="col-lg-3" style="width: 20rem;">
                        <img src="{{asset('venda-carros/assets/img/vw-golf.png')}}" class="card-img-top" alt="Volkswagen Golf">
                        <div class="card-body">
                            <h3>Volkswagen Golf</h3>
                        </div>
                    </div>
                    <div class="col-lg-3" style="width: 18rem;">
                        <img src="{{asset('venda-carros/assets/img/cg-125.png')}}" class="card-img-top" alt="Honda Cg 125">
                        <div class="card-body">
                            <h3>Honda Cg 125</h3>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="{{asset('venda-carros/assets/img/testimonials-1.jpg')}}" alt="..." />
                            <h5>Margaret E.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="{{asset('venda-carros/assets/img/testimonials-2.jpg')}}" alt="..." />
                            <h5>Fred S.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="{{asset('venda-carros/assets/img/testimonials-3.jpg')}}" alt="..." />
                            <h5>Sarah W.</h5>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        ...
                        <p class="text-white small mb-4 mb-lg-0">&copy; Your Website 2021. All Rights Reserved.</p>
                    </div>
